...
#define CONFIG_MS_NO_RECOVERY      1
#define CONFIG_MS_NO_LOGO      1
...
#define CONFIG_SYS_PROMPT	"Chicago # "	/* Monitor Command Prompt   */
...
#define CONFIG_SYS_TEXT_BASE	0x27E00000
