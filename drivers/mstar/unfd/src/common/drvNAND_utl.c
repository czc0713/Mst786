...
U32 drvNAND_SearchCIS(void)
{
	...
	//printf("d.pNandDrv->u8_WordMode : %X\r\n", pNandDrv->u8_WordMode);
	...
	for (u16_PBA = 0; u16_PBA < 0x40; u16_PBA++)
	{
		...
		//printf("e.pNandDrv->u8_WordMode : %X\r\n", pNandDrv->u8_WordMode);
		...
		printf("f.pNandDrv->u8_WordMode : %X\r\n", pNandDrv->u8_WordMode);
		...
		{
			printf("pNandDrv->u8_CellType is 0\r\n");
