...
PanelType  tPanelHSD_070I_3459__MST786_HZCAR[] =
{
    {
        "AT_070_TN94",//m_pPanelName
        0,          //BOOL m_bPanelDither :1;           //PANEL_DITHER          // 8/6 bits panel
        LINK_TTL,  //BOOL m_ePanelLinkType :2;         //PANEL_LINK
        0,          //BOOL m_bPanelDualPort :1;         //PANEL_DUAL_PORT
        0,                    // shall swap if
        ...
        625,        //WORD m_wPanelMaxVTotal;           //PANEL_MAX_VTOTAL
        525,	//ori:525,        //WORD m_wPanelVTotal;              //PANEL_VTOTAL 20060511 chris :for Frame Lock operation
        475,  //475,        //WORD m_wPanelMinVTotal;           //PANEL_MIN_VTOTAL
        36,  //40,//29, //26M  //29, //DWORD m_dwPanelMaxDCLK;
        33, //30,//26,        //26, //DWORD m_dwPanelDCLK;
        30,  // 25,//24,      //24, //DWORD m_dwPanelMinDCLK;
        0x0019,     //m_wSpreadSpectrumStep;        //Value for Spread_Spectrum_Control register(B7..3:Period,B2..0:Amplitude)
        0x00C0,     //m_wSpreadSpectrumSpan;        //Value for Spread_Spectrum_Control register(B7..3:Period,B2..0:Amplitude)
        0x6D,       //m_ucDimmingCtl
        255,        //m_ucMaxPWMVal;
...
PanelType  tPanelHSD_070I_3210__MST786_HZCAR[] =
{
    {
        "A0_70_VW04",//m_pPanelName
        0,          //BOOL m_bPanelDither :1;           //PANEL_DITHER          // 8/6 bits panel
        LINK_TTL,  //BOOL m_ePanelLinkType :2;         //PANEL_LINK
        0,          //BOOL m_bPanelDualPort :1;         //PANEL_DUAL_PORT
        0,                    // shall swap if
...
PanelType  tPanelHSD_062I_DW1__MST786_SZDEMO[] =
{
    {
