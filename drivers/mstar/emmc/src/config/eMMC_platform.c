...
//=============================================================
#elif (defined(eMMC_DRV_CEDRIC_UBOOT)&&eMMC_DRV_CEDRIC_UBOOT)
#if 0
{
#endif
...
#define MODE_MASK				BIT_MACRO_EN | BIT_SD_DDR_EN | BIT_SD_BYPASS_MODE_EN | BIT_SD_SDR_IN_BYPASS | BIT_SD_FROM_TMUX
...
//			    BIT_MACRO_EN|BIT_SD_DDR_EN|BIT_SD_BYPASS_MODE_EN|BIT_SD_SDR_IN_BYPASS|BIT_SD_FROM_TMUX);
	...
	switch(u32_FCIE_IF_Type)
	{
		case FCIE_eMMC_DDR:
			  ...
			  REG_FCIE_CLRBIT(FCIE_BOOT_CONFIG, MODE_MASK);
	...
	switch(u32_FCIE_IF_Type)
	{
		...
		case FCIE_eMMC_BYPASS:
			...
			REG_FCIE_W(REG_PADTOP_40, u16_reg);
  			...
  			REG_FCIE_CLRBIT(REG_CLK_4X_DIV_EN, BIT0);
...
{
	eMMC_PlatformResetPre();
	//RETAILMSG(1, (TEXT("eMMC_clock_setting : %X\r\n"), u32ClkParam));
#if DDR_MODE
	switch(u32ClkParam) {
...
U16 gau16_FCIEClkSel[eMMC_FCIE_VALID_CLK_CNT]={
	NFIE_REG_4XCLK_192M, NFIE_REG_4XCLK_176_8M, NFIE_REG_4XCLK_160M, NFIE_REG_4XCLK_147M, NFIE_REG_4XCLK_120M,
	NFIE_REG_4XCLK_96M, NFIE_REG_4XCLK_80M, NFIE_REG_4XCLK_60M, NFIE_REG_4XCLK_48M, NFIE_REG_4XCLK_26M
};

#define FCIE_SLOW_CLK_4X		NFIE_REG_4XCLK_26M
