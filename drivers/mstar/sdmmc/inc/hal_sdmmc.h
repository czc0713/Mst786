...
#define V_MIUCLK_CTRL_INIT			(R_MIU_CLK_EN_HW)  //Not Support
...
#define EN_MIU_WDEN_PATCH_DIS       // set miu_trx_cnt =miu_dff_sdio_size

#define V_MIUCLK_CTRL_INIT			// MIU Clock Contrl
#define V_MIUBUS_CTRL_INIT			// MIU Bus Control

#define WT_EVENT_RSP			    // Waiting time for Command Response
#define WT_EVENT_READ			    // Waiting time for Read
#define WT_EVENT_WRITE			    // Waiting time for Write
