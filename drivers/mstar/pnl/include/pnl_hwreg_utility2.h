...
#define _PK_L_(bank, addr)   (((U16)(bank) << 8) | (U16)((addr)*2))
#define _PK_H_(bank, addr)   (((U16)(bank) << 8) | (U16)((addr)*2+1))
...
INTERFACE U32 gu32PnlRiuBaseAddr;     // This should be inited before XC library starting.
INTERFACE U32 gu32PMRiuBaseAddr;
...
static U16 RIU_READ_BYTE(U32 addr )
{
    return INREG8( gu32PMRiuBaseAddr + (addr) );
}
static U16 RIU_READ_2BYTE(U32 addr )
{
    return INREG16( gu32PMRiuBaseAddr + (addr) );
}
//#define RIU_READ_2BYTE(addr)        ( READ_WORD( gu32PMRiuBaseAddr + (addr) ) )
#define RIU_WRITE_BYTE(addr, val)   OUTREG8( gu32PMRiuBaseAddr + (addr), val)
#define RIU_WRITE_2BYTE(addr, val)  OUTREG16( gu32PMRiuBaseAddr + (addr), val)

static U16 PM_RIU_READ_BYTEM(U32 addr )
{
    return INREG8( gu32PMRiuBaseAddr + (addr) );
}
static U16 PM_RIU_READ_2BYTE(U32 addr )
{
    return INREG16( gu32PMRiuBaseAddr + (addr) );
}
// Address bus of RIU is 16 bits for PM //alex_tung
//#define PM_RIU_READ_BYTEM(addr)        ( INREG8( gu32PMRiuBaseAddr + (addr) ) )
//#define PM_RIU_READ_2BYTE(addr)        ( INREG16( gu32PMRiuBaseAddr + (addr) ) )
#define PM_RIU_WRITE_BYTE(addr, val)   OUTREG8( gu32PMRiuBaseAddr + (addr), val)
#define PM_RIU_WRITE_2BYTE(addr, val)  OUTREG16( gu32PMRiuBaseAddr + (addr), val)
...
#define SC_W4BYTE( u32Reg, u32Val)\
            RIU_WRITE_2BYTE( (REG_SCALER_BASE + ((u32Reg) & 0xFFFF) ) <<1, (U16)((u32Val) & 0x0000FFFF) ) ; \
            RIU_WRITE_2BYTE( (REG_SCALER_BASE + ((u32Reg) & 0xFFFF) + 2 ) << 1, (U16)(((u32Val) >> 16) & 0x0000FFFF) )

#define SC_R4BYTE( u32Reg )\
            RIU_READ_2BYTE( (REG_SCALER_BASE + ((u32Reg) & 0xFFFF) ) << 1 ) | ((U32)(RIU_READ_2BYTE( (REG_SCALER_BASE + ((u32Reg) & 0xFFFF) + 2 ) << 1 )) << 16)
...
static U16 SC_R2BYTE(U32 u32Reg )
{
    return RIU_READ_2BYTE( (REG_SCALER_BASE + ((u32Reg) & 0xFFFF) ) <<1 );
}
static U32 SC_R4BYTE(U32 u32Reg )
{
    return RIU_READ_2BYTE( (REG_SCALER_BASE + ((u32Reg) & 0xFFFF) ) << 1 ) | ((U32)(RIU_READ_2BYTE( (REG_SCALER_BASE + ((u32Reg) & 0xFFFF) + 2 ) << 1 )) << 16);
}
static U16 SC_R2BYTEMSK(U32 u32Reg, U16 u16mask)
{
    return (RIU_READ_2BYTE( (REG_SCALER_BASE + ((u32Reg) & 0xFFFF) ) << 1) & (u16mask));
}
#endif
#else
#define SC_W2BYTE( u32Reg, u16Val)\
...
#define SC_W4BYTE( u32Reg, u32Val)\
            RIU_WRITE_2BYTE(REG_SCALER_BASE<<1, ((u32Reg) >> 8) & 0x00FF ) ; \
            RIU_WRITE_2BYTE( (REG_SCALER_BASE + ((u32Reg) & 0xFF) ) <<1, (U16)((u32Val) & 0x0000FFFF) ) ; \
            RIU_WRITE_2BYTE( (REG_SCALER_BASE + ((u32Reg) & 0xFF) + 2 ) << 1, (U16)(((u32Val) >> 16) & 0x0000FFFF) )

#define SC_R4BYTE( u32Reg )\
            RIU_WRITE_2BYTE(REG_SCALER_BASE << 1, ((u32Reg) >> 8) & 0x00FF ) ; \
            RIU_READ_2BYTE( (REG_SCALER_BASE + ((u32Reg) & 0xFF) ) << 1 ) | ((U32)(RIU_READ_2BYTE( (REG_SCALER_BASE + ((u32Reg) & 0xFF) + 2 ) << 1 )) << 16)
...
#if 1
static U16 MOD_R2BYTE( U32 u32Reg )
{
    RIU_WRITE_2BYTE(REG_MOD_BASE << 1, ((u32Reg) >> 8) & 0x00FF );
    return RIU_READ_2BYTE( (REG_MOD_BASE + ((u32Reg) & 0xFF) ) << 1);
}

static U16 MOD_R2BYTEMSK( U32 u32Reg, U16 u16mask)
{
    RIU_WRITE_2BYTE(REG_MOD_BASE << 1, ((u32Reg) >> 8) & 0x00FF );
