...
typedef struct
{
    U8 eSupportGammaType;                        ///< refer to HAL_PNL_GAMMA_TYPE
    U8 eSupportGammaMapMode;                       ///< refero to HAL_PNL_GAMMA_MAPPEING_MODE
} PNL_HalInfo;
...
#define REG_GPIO0_56_L              (REG_GPIO0_BASE + 0xAC)
...
#define LVDS_MPLL_CLOCK_MHZ     442 // For crystal 26Mhz
...
//void _MDrv_PNL_Set_12BIT_Gamma( U8 u8Channel, U8 * u8Tab );
...
U8 MHal_PNL_MOD_Control_Out_TTL_Resistor_OP (U8  u16TTL_OP_Level);
